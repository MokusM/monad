const config = {
    ...
    // Налаштування безпеки та приватності
    PRIVACY: {
        SHUFFLE_WALLETS: true,       // Перемішувати гаманці перед кожним запуском
        SHUFFLE_SEED: 'random',      // 'random' або рядок для конкретного seed
        RANDOM_DELAYS: true,         // Додавати випадкові затримки між операціями гаманців
    },
